 ...
 *
 * <p>NcJmsIO source returns unbounded collection of JMS records as {@code PCollection<JmsRecord>}.
 ...
 * <pre>{@code
 *
 * pipeline.apply(NcJmsIO.<T>readMessage()
 *    .withConnectionFactory(myConnectionFactory)
 *    .withQueue("my-queue")
 ...
 *
 * <p>NcJmsIO sink supports writing text messages to a JMS destination on a broker.
...
public class NcJmsIO {
    ...
    /**
     * A {@link PTransform} to read from a JMS destination. See {@link NcJmsIO} for more
    ...
    public abstract static class Read<T> extends PTransform<PBegin, PCollection<T>> {
         ...
         * <pre>
         *   {@code
         *    pipeline.apply(NcJmsIO.read().withConnectionFactory(myConnectionFactory)
         *   }
         * </pre>
         *
         * @param connectionFactory The JMS {@link ConnectionFactory}.
         * @return The corresponding {@link NcJmsIO.Read}.
         */
         ...
         * {@link NcJmsIO.Read} acts as a consumer on the queue.
         *
         * <p>This method is exclusive with {@link NcJmsIO.Read#withTopic(String)}. The user has to
         ...
         * <pre>
         *   {@code
         *    pipeline.apply(NcJmsIO.read().withQueue("my-queue")
         *   }
         * </pre>
         *
         ...
         * {@link NcJmsIO.Read} acts as a subscriber on the topic.
         *
         * <p>This method is exclusive with {@link NcJmsIO.Read#withQueue(String)}. The user has to
         * specify a destination: queue or topic.
         *
         * <p>For instance:
         *
         * <pre>
         *   {@code
         *    pipeline.apply(NcJmsIO.read().withTopic("my-topic")
         *   }
         * </pre>
         *
         ...
         * <pre>
         *   {@code
         *    pipeline.apply(NcJmsIO.read().withNumRecords(1000)
         *   }
         * </pre>
         *
         ...
         * <pre>
         *   {@code
         *    pipeline.apply(NcJmsIO.read().withMaxReadTime(Duration.minutes(10))
         *   }
         * </pre>
         *
    ...
    /**
     * An interface used by {@link NcJmsIO.Read} for converting each jms {@link Message} into
    ...
    static class UnboundedJmsReader<T> extends UnboundedReader<T> {
        ...
        public boolean start() throws IOException {
            ...
            try {
                if (spec.getTopic() != null) {
                    this.consumer =
                            this.session.createConsumer(CommonContextProvider.provide().jndiTemplate().lookup(spec.getTopic(), Destination.class, 5000L));
                } else {
                    this.consumer =
                            this.session.createConsumer(CommonContextProvider.provide().jndiTemplate().lookup(spec.getQueue(), Destination.class, 5000L));
                }
            } catch (Exception e) {
    ...
    /**
     * A {@link PTransform} to write to a JMS queue. See {@link NcJmsIO} for
    ...
    public abstract static class Write extends PTransform<PCollection<String>, PDone> {
         ...
         * <pre>
         *   {@code
         *    .apply(NcJmsIO.write().withConnectionFactory(myConnectionFactory)
         *   }
         * </pre>
         *
         * @param connectionFactory The JMS {@link ConnectionFactory}.
         ...
         * {@link NcJmsIO.Write} acts as a producer on the queue.
         *
         * <p>This method is exclusive with {@link NcJmsIO.Write#withTopic(String)}. The user has to
         * specify a destination: queue or topic.
         *
         * <p>For instance:
         *
         * <pre>
         *   {@code
         *    .apply(NcJmsIO.write().withQueue("my-queue")
         *   }
         * </pre>
         *
         ...
         * {@link NcJmsIO.Read} acts as a publisher on the topic.
         *
         * <p>This method is exclusive with {@link NcJmsIO.Write#withQueue(String)}. The user has to
         * specify a destination: queue or topic.
         *
         * <p>For instance:
         *
         * <pre>
         *   {@code
         *    .apply(NcJmsIO.write().withTopic("my-topic")
         *   }
         * </pre>
         *
         * @param topic The JMS topic name.
