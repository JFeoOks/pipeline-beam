...
final class AutoValue_JdbcIO_DataSourceConfiguration extends NcJdbcIO.DataSourceConfiguration {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof NcJdbcIO.DataSourceConfiguration) {
            NcJdbcIO.DataSourceConfiguration that = (NcJdbcIO.DataSourceConfiguration) o;
    ...
    @Override
    NcJdbcIO.DataSourceConfiguration.Builder builder() {
        return new Builder(this);
    }

    static final class Builder extends NcJdbcIO.DataSourceConfiguration.Builder {
        ...
        private Builder(NcJdbcIO.DataSourceConfiguration source) {
        ...
        @Override
        NcJdbcIO.DataSourceConfiguration.Builder setDriverClassName(@Nullable ValueProvider<String> driverClassName) {
            this.driverClassName = driverClassName;
            return this;
        }
        @Override
        NcJdbcIO.DataSourceConfiguration.Builder setUrl(@Nullable ValueProvider<String> url) {
            this.url = url;
            return this;
        }
        @Override
        NcJdbcIO.DataSourceConfiguration.Builder setUsername(@Nullable ValueProvider<String> username) {
            this.username = username;
            return this;
        }
        @Override
        NcJdbcIO.DataSourceConfiguration.Builder setPassword(@Nullable ValueProvider<String> password) {
            this.password = password;
            return this;
        }
        @Override
        NcJdbcIO.DataSourceConfiguration.Builder setConnectionProperties(@Nullable ValueProvider<String> connectionProperties) {
            this.connectionProperties = connectionProperties;
            return this;
        }
        @Override
        NcJdbcIO.DataSourceConfiguration.Builder setDataSource(@Nullable DataSource dataSource) {
            this.dataSource = dataSource;
            return this;
        }
        @Override
        NcJdbcIO.DataSourceConfiguration build() {
